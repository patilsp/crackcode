...
export default function Banner() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 rounded-xl shadow-md">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        {/* Left Section */}
        <div className="flex flex-col justify-center text-center lg:text-left">
          ...
          <motion.p
            className="mt-4 max-w-xl mx-auto lg:mx-0 text-lg text-slate-600 dark:text-slate-300"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            Master essential concepts, tackle tricky questions, and ace every interview with expert guidance.
          </motion.p>

          {/* Features */}
          <motion.div
            className="mt-6 flex flex-col sm:flex-row sm:flex-wrap gap-4 justify-center lg:justify-start"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
